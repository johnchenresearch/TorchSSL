...
from models.fastfixmatch.fastfixmatch import FastFixMatch
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # SET fastfixmatch: class fastfixmatch in models.fastfixmatch
    ...
    model = FastFixMatch(_net_builder,
                     args.num_classes,
                     args.ema_m,
                     args.T,
                     args.p_cutoff,
    ...
    ## set SGD and cosine lr on fastfixmatch
    ...
    if args.dataset.lower() != "imagenet":
        train_dset = SSL_Dataset(args, alg='fastfixmatch', name=args.dataset, train=True,
                                num_classes=args.num_classes, data_dir=args.data_dir)
        lb_dset, ulb_dset = train_dset.get_ssl_dset(args.num_labels)
        _eval_dset = SSL_Dataset(args, alg='fastfixmatch', name=args.dataset, train=False,
                                num_classes=args.num_classes, data_dir=args.data_dir)
    ...
    ## set DataLoader and ulb_dset on FastFixMatch
    ...
    # START TRAINING of fastfixmatch
    trainer = model.train
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sn', '--save_name', type=str, default='fastfixmatch')
    ...
    '''
    Training Configuration of fastfixmatch
    '''
